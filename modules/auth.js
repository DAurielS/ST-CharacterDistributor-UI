/**
 * ST-CharacterDistributor-UI - Authentication Module
 * Contains functions for handling Dropbox authentication and token management
 */

// Holds the current authentication data
let authData = {
    accessToken: null,
    refreshToken: null,
    expiresIn: null,
...
/**
 * Start the Dropbox authentication process
 * Uses OAuth2 PKCE flow for improved security
 */
 ...
 * @param {string} code - The authorization code from OAuth flow
 ...
 * @param {number|string} expiresIn - Token expiration time in seconds
 ...
 * @param {MessageEvent} event - The message event from the popup window
 */
...
/**
 * Check localStorage for a stored token and attempt to use it
 */
...
/**
 * Refresh the authentication status from the server
 */
